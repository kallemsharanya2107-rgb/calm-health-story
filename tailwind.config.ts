  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Health category semantic colors
        medication: {
          DEFAULT: "hsl(var(--medication))",
          light: "hsl(var(--medication-light))",
        },
        vitals: {
          DEFAULT: "hsl(var(--vitals))",
          light: "hsl(var(--vitals-light))",
        },
        sleep: {
        ...
        cycle: {
          ...
          light: "hsl(var(--cycle-light))",
        },
        symptoms: {
          DEFAULT: "hsl(var(--symptoms))",
          light: "hsl(var(--symptoms-light))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
